        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10 font-sans text-gray-700 leading-relaxed text-sm">
            <section>
              ...
              <p>
                This website is operated by <strong>The LyynClothing</strong>.
                Throughout the site, the terms “we”, “us” and “our” refer to
                The LyynClothing. We offer this website, including all information,
            ...
            <section className="bg-gray-50 p-8 rounded-xl border border-gray-100">
              ...
              <p className="mb-4">
                ...
                payment processing. By transacting on The LyynClothing, you agree
                to the following:
              </p>
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  The LyynClothing is not liable for any transaction failures or
            ...
            <section className="bg-black text-white p-8 rounded-xl">
              ...
              <p className="font-medium text-gray-300">
                ...
                <strong>The Lyyn.clothing15@gmail.com</strong> or WhatsApp{" "}
            ...
            <section>
              ...
              <p>
                In no case shall The LyynClothing, our directors, or employees be
            ...
            <section className="pt-10 border-t border-gray-100 text-center">
              ...
              <p className="font-bold text-black mt-2">
                Email: The Lyyn.clothing15@gmail.com
              </p>

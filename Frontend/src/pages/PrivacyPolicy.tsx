        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 font-sans text-gray-700 leading-relaxed text-sm">
            <section>
              ...
              <p>
                The online store www.The Lyynclothing.com ("Online Store") is owned
                and operated by The Lyyn Pvt Ltd, under the laws of India having
                its registered office in Delhi. Through this Policy,
                The LyynClothing intends to convey the manner in which the user’s
            ...
            <section>
              ...
              <p>
                ...
                Support Team at <strong>The Lyyn.clothing15@gmail.com</strong> or
